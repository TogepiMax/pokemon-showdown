export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	primeape: {
		...
		evos: ["Annihilape"],
		eggGroups: ["Field"],
		otherFormes: ["Primeape-Bluris"],
		formeOrder: ["Primeape", "Primeape-Bluris"],
	},
	primeapebluris: {
		num: 57,
		name: "Primeape-Bluris",
		baseSpecies: "Primeape",
		forme: "Bluris",
		types: ["Fighting", "Fairy"],
		baseStats: {hp: 80, atk: 35, def: 75, spa: 105, spd: 80, spe: 80},
		abilities: {0: "Vital Spirit", 1: "Own Tempo", H: "Intimidate"},
		heightm: 0.9,
		weightkg: 28,
		color: "Pink",
		prevo: "Mankey",
